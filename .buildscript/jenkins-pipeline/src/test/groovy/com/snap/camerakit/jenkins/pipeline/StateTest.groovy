    ...
    void toJson_fromJson_equals() {
        ...
        state.stage4.releaseCandidateBinaryBuilds = [
                'SDK distribution Android sample app build' : new BinaryBuild(
                        ...
                        'snapengine-builder.sc-corp.net',
                        'https://store.snap.applivery.io/camerakit-sample-partner-android-release?os=android&build=67d98ab3eef8bc53585b95a5',
                        null
                ),
                ...
                'SDK distribution iOS sample app build' : new BinaryBuild(
                        ...
                        'snapengine-builder.sc-corp.net',
                        'https://store.snap.applivery.io/camerakit-sample-partner-ios-release?os=ios&build=67d494005e3084a120dda2b9',
                        null
                ),
        ]
